...
//TODO: Напишите тесты для всех редьюсеров.

// TODO: Напишите тесты для асинхронных операций. Тестировать асинхронные операции,
// где есть взаимодействие с внешними зависимостями, такими как localStorage пока не нужно.
